...
public class LinkedInControl {
    ...
    public void checkAccessTokenValidity(String url, String urlParameters, LinkedInAccessTokenValidationResponse linkedInAccessTokenValidationResponse){
        new LinkedInAsyncTask(url, urlParameters, MODE_ACCESS_TOKEN_VALIDATION, linkedInAccessTokenValidationResponse).execute();
    }
}
